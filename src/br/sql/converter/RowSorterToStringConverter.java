...
/**
 * Binding converter between String and regex RowFilter (encapsulated by
 * RowSorterToStringConverter).
 *
...
public class RowSorterToStringConverter extends Converter {
    ...
    public Object convertReverse(Object mask) {
        ...
        //sorter.setRowFilter(RowFilter.regexFilter("(?i).*" + sb + ".*"));
